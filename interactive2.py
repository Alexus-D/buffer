...
class InteractiveParameterSelector2:
    ...
    def _create_peaks_plot__(self, title):
        ...
        peak_1_values = self.data['peaks_data']['modes'][0]
        peak_2_values = self.data['peaks_data']['modes'][1]
...
def plot_interactive_contour_map(data, buttons, title='Interactive Contour Map', plot_type='contour', clear_buttons=True):
